...
class LazyRuleAwareWithBaseConfigurationMetadata implements ModuleConfigurationMetadata {
    ...
    public ImmutableList<? extends ComponentArtifactMetadata> getArtifacts() {
        if (computedArtifacts == null) {
            computedArtifacts = variantMetadataRules.applyVariantFilesMetadataRules(this, base == null ? ImmutableList.of() : base.getArtifacts(), componentId);
        }
    ...
    public ImmutableSet<String> getHierarchy() {
        return base == null ? ImmutableSet.of() : base.getHierarchy();
    }

    @Override
    public ImmutableList<ExcludeMetadata> getExcludes() {
        return base == null ? ImmutableList.of() : base.getExcludes();
    }

    @Override
    public boolean isTransitive() {
        return base == null || base.isTransitive();
    }

    @Override
    public boolean isVisible() {
        return base == null || base.isVisible();
    }

    @Override
    public boolean isCanBeConsumed() {
        return base == null || base.isCanBeConsumed();
    }

    @Override
    public boolean isCanBeResolved() {
        return base != null && base.isCanBeResolved();
    }

    @Override
    public List<String> getConsumptionAlternatives() {
        return base == null ? ImmutableList.of() : base.getConsumptionAlternatives();
    }
}
